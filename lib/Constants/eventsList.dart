class L {
  ...
  static const List<Map<String, String>> miniEvents=[
    ...
    "Name of the events": "Nail Art",
      "Description ": "Each team will have 2 members. Faculty will be present as judge. One member has to design nails of the other' participants need to bring their own materials.",
    ...
    },
    {
      ...
      "Description ": "Participants will have to do out of box thinking to utilise the waste in a better way. \nThey will be provided 2 hrs to do so.",
    ...
    },
    {
      ...
      "Description ": "Each team can comprise of maximum 3 members.They have to make rangoli using colors provided by us.\n ",
    ...
    },
    {
      ...
      "Description ": "Round 1: A form of performance poetry that will combine the elements of performance,writing,competition, audience participation and storytelling.The rules of slam poetry are-*Poems can be on any subject and in any style. *No props *Must be an original work.*\nRound 2: Qualified participants will have to recite their own poems. Two winners will be decided after this round",
      "Date": "During Event",
      "Time": "To be updated soon"
    },
    {
      "Name of the events": "Jurassic chase",
      "Description ": "Musical Chair- This will be a fun event.In first round we will have maximum of 10 chairs and this will eliminate a large\nnumber of participants, winners will move foreward to the second round  where we will remove half of the chairs\nWe can have 3 rounds like this and winners of these 3 rounds will again fight to be the winner.",
    ...
    },
    {
      ...
      "Description ": "It is an online event in which a group of participants will shoot short and funny ads of stipulated\ntime. and this video will be uploaded on the official you tube page of Eclectika.",
      "Date": "During Event",
      "Time": "To be updated soon"
    },
  ];
  ...
  static const List<Map<String, String>> megaEvents=[
    {
      ...
      "No. of Rounds": "2",
      "Description ": "Traditional fashion event\nR1- Demonstrate any talent one posses\nR2- Interview",
      "Venue": "E-Hall",
    ...
    "Name of the events": "Eclectika Idol",
      "No. of Rounds": "3",
      "Description ": "R1- Screening on the basis of submitted singing video clip\nR2- Singing performance for finals\nR3-live singing performance\r",
      "Venue": "R1- E-Hall\nR2- Cycle Stand",
    ...
    "Image" : "asset/Posters/abhirbhaav.jpeg",
      ...
      "No. of Rounds": "2",
      "Description ": "R1- Screening on the basis of submitted band video clip\nR2- live band performances",
      "Venue": "CycleStand",
      "Time": "10/02/23\n1:00-4:00 pm"
    },
    {
    ...
    "Name of the events": "Goonj",
      "No. of Rounds": "2",
      "Description ": "R1-Screening on the basis of submitted nukkad natak video clips \nR2-live nukkadnatak performance",
      "Venue": "Faculty Parking",
      "Time": "10/02/23\n11:00-1:30 pm"
    },
  ];
